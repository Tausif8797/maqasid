...
const memberLoanRequestRoutes = require('./routes/memberLoanRequestRoutes')
const adminLoanRequestRoutes = require('./routes/adminLoanRequestRoutes')
...
app.use('/api/member/loan-requests', memberLoanRequestRoutes)
app.use('/api/admin/loan-requests', adminLoanRequestRoutes)
